...
public class Reporter {
    ...
    private static ExtentReports createExtentReport() {
        ...
        String reportFilePath = System.getProperty("user.dir") + "/reports/automation_report.html";

        ExtentSparkReporter sparkReporter = new ExtentSparkReporter(reportFilePath);

        sparkReporter.config().setTheme(Theme.DARK);
        sparkReporter.config().setReportName("Automation Test Report");
        sparkReporter.config().setDocumentTitle("Automation Test Automation Report");
        sparkReporter.config().setTimeStampFormat("dd/MM/yyyy hh:mm:ss");
    ...
    public static ExtentTest createStep(ExtentTest test, String stepName, String stepDetails) {
        return test.createNode(stepName, stepDetails);
    }
}
